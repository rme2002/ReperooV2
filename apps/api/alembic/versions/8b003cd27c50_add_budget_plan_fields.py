...
def upgrade() -> None:
    """Upgrade schema."""
    # Add new columns
    op.add_column('budget_plans', sa.Column('payday_day_of_month', sa.Integer(), nullable=True))
    op.add_column('budget_plans', sa.Column('pay_schedule', sa.String(20), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_constraint('ck_budget_plans_investment_goal_positive', 'budget_plans', type_='check')
    op.drop_constraint('ck_budget_plans_savings_goal_positive', 'budget_plans', type_='check')
