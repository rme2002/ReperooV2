...
def downgrade() -> None:
    ...
    op.add_column('budget_plans', sa.Column('payday_day_of_month', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('budget_plans', sa.Column('pay_schedule', sa.VARCHAR(length=20), autoincrement=False, nullable=True))
