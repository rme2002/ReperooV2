...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['expense_subcategory_id'], ['expense_subcategories.id']),
    ...
    op.create_index('idx_recurring_templates_user_id', 'recurring_templates', ['user_id'])
    op.create_index('idx_recurring_templates_start_date', 'recurring_templates', ['start_date'])
    op.create_index('idx_recurring_templates_is_paused', 'recurring_templates', ['is_paused'])
    ...
    op.drop_constraint('fk_transactions_recurring_template_id', 'transactions', type_='foreignkey')
    ...
    op.create_index('idx_transactions_recurring_template_id', 'transactions', ['recurring_template_id'])
