...
#   filename:  api.yaml
#   timestamp: 2026-01-11T13:07:45+00:00
...
class CreateBudgetPlanPayload(BaseModel):
    ...
    payday_day_of_month: Optional[conint(ge=1, le=31)] = Field(
        None, description='Day of month for payday', examples=[1]
    )
...
class UpdateBudgetPlanPayload(BaseModel):
    ...
    payday_day_of_month: Optional[conint(ge=1, le=31)] = Field(
        None, description='Day of month for payday'
    )
    pay_schedule: Optional[PaySchedule] = None
