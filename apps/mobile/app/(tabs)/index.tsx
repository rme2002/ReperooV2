...
const metrics = [
  { label: 'Active projects', value: '12', trend: '+3 this week', color: '#38bdf8' },
  { label: 'Realtime checks', value: '98%', trend: 'Healthy', color: '#a78bfa' },
  { label: 'Team online', value: '24', trend: '8 collaborating now', color: '#34d399' },
];
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.hero}>
        ...
        <Text style={styles.subtitle}>Here is what your teams shipped overnight.</Text>
      </View>
