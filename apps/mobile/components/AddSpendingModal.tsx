...
export function AddSpendingModal({
  ...
  const formValid = isAmountValid && isCategoryValid;
    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <View style={styles.overlay}>
        <Pressable
          ...
          accessibilityLabel="Close spending form"
        />
        <View style={styles.sheet}>
          <View style={styles.sheetHeader}>
            <Text style={styles.title}>
              {mode === "edit" ? "Edit spending" : mode === "view" ? "Transaction overview" : "Add spending"}
            </Text>
          ...
          >
            ...
            <View style={styles.surface}>
              ...
              <Text style={styles.recurringCopy}>Repeat this spending every month on the selected date.</Text>
              {isRecurring ? (
                <View style={styles.recurringDayBlock}>
                  ...
                  <Text style={styles.recurringHelper}>We’ll auto-post this on the selected day each month.</Text>
                </View>
              ) : null}
            </View>
          </ScrollView>
          ...
          {mode === "view" ? (
            ...
            <Pressable
              style={({ pressed }) => [
                ...
                pressed && formValid && styles.saveButtonPressed,
              ]}
